...
export default function ProductTable({ productList, categoryList, productStatusList }: {
  productList: Product[],
  categoryList: any,
  ...
  return (
    ...
    >
      ...
      >
        <StyledTypography variant="h4">Sản phẩm</StyledTypography>
        <form
          style={{
            display: "flex",
          }}
            ...
            .map((row: any) => (
              <TableRow key={row.productId}>
                ...
                <TableCell align="justify">{
                  productStatusList.find(
                    (productStatusList: any) => productStatusList.statusId === row.status
                  ).status
                }</TableCell>
                <TableCell>
