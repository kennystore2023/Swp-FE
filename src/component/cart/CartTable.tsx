            ...
            <TableRow key={key}>
              <TableCell component="th" scope="row">
                ...
                >
                  <Checkbox
                    color="success"
                    disabled={!(row.product.status !== 4 && row.product.quantity !== 0 )}
                    onChange={(event) => {
              ...
              <TableCell align="center">
                {(row.product.status !== 4 && row.product.quantity !== 0 ) ? (
                  <ChangeQuatityButton
                  ...
                  >
                    Sản phẩm đã bị xóa hoặc đã hết hàng
                  </Typography>
                )}
              </TableCell>
              <TableCell align="center">
